...
plt.scatter(x_train[y_train == 0, 0], x_train[y_train == 0, 1], c='blue', label='Normal', alpha=0.6)
plt.scatter(x_train[y_train == 1, 0], x_train[y_train == 1, 1], c='red', label='Outliers', alpha=0.6)
plt.title('Training Samples with Outliers')
